          ...
          <div className="max-w-4xl w-full mx-auto p-4 flex flex-col gap-10">
            ...
            <div className="text-gray-600 flex flex-col gap-5">
              <p className="">
                ...
                sequi ullam, ducimus ipsum amet commodi, adipisci ab nobis
                minima ut? Ipsa possimus aliquam explicabo exercitationem error
                ...
                provident distinctio nam illum reiciendis dolorum voluptas
                minima aperiam. Magni, velit!
              </p>
              <p className="">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum
                quaerat eius dignissimos. Tenetur dolorum quia iusto nihil nam
